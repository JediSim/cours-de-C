This is gnuplot version 5.4.2 -- binary distribution for Windows
===========================================================================

This updated binary release fixes packaging errors.
...
This version still contains a bug which prevents use of (interactive) pipe
input:  https://sourceforge.net/p/gnuplot/bugs/2412/

Text size in cairo terminal (pngcairo, pdfcairo, wxt) might be incorrect and
depend on the Windows scale factor: https://sourceforge.net/p/gnuplot/bugs/2261/

On some systems, the fontconfig library used by the qt terminal seems to have
issues with storing the font cache and hence takes a long time for the first plot
of a session: https://sourceforge.net/p/gnuplot/bugs/2316/

Please also see and use
